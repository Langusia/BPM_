...
public record CheckCardInitiateHandler(BpmStore<CheckCard> _bpm, IDocumentSession _session, IQuerySession _qSession) : IRequestHandler<CheckCardInitiate, bool>
{
    private readonly IQuerySession _qSession = _qSession;
    private readonly BpmStore<CheckCard> _bpm = _bpm;
