...
// {
//     public static IProcessNodeInitialBuilder<T> Or<TCommand, T>(this IProcessNodeInitialBuilder<T> builder, INode node, Action<INodeDefinitionBuilder>? configure = null) where T : Aggregate
//     {
...
//
//     public static IProcessNodeInitialBuilder<T> ThenContinue<TCommand, T>(this IProcessNodeInitialBuilder<T> builder, Action<INodeDefinitionBuilder>? configure = null) where T : Aggregate =>
...
//         {
//             var nextNodeBuilder = new NodeInitialBuilder(node, builder.GetProcess());
